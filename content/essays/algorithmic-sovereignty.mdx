---
layout: post
title: Algorithmic Sovereignity and Datapower
subtitle: Nation-state sovereignty is waning, with digital infrastructure taking its place. This essay discusses the conditions that have enabled technology firms to bring about the greatest global political transformation since the end of feudalism.
tags:
  - Sovereignty
  - Datapower
cover_image: ../../src/images/algorithmic-sovereignty/datacenter.png
...
<blockquote className="blockquote-page">
  ...
  <p className="small small-caps attribution">Michel Foucault, "Of Other Spaces"</p>
  ...
  <p className="small small-caps attribution">Wendy Brown, <em>Walled States, Waning Sovereignty</em></p>
  <hr className="hr-short" />
  <p>It's already turned loose. / It's already coming. / It can't be called back.</p>
  <p className="small small-caps attribution">Leslie Marmon Silko, <em>Ceremony</em></p>
</blockquote>

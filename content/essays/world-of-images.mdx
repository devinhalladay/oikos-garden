...
tags: ["Images", "Technics", "Dialectics", "Aesthetics", "Semiotics (Structural)"]
date: "2019-01-10"
---
...
Only after the completion of this essay did I uncover a quote from Calvino: *“We live in an unending rainfall of images. The most powerful media transform the world into images and multiply it by means of the phantasmagoric play of mirrors.”* In this work I explore the same metaphor: a world of images, a phantasmagoria, and a sensory convlusion. I will formalize this metaphor through structural semiotics, arguing that there is, in fact, *nothing* outside of the image.[^3]
...
<Figure src={"/images/world-of-images/image1.png"}>
  ...
  *Figure 1* — The cycle of interdependence between different types of images.
...
<Figure src={"/images/world-of-images/image2.png"}>
  ...
  *Figure 2* — A subjunctive diagram explaining the chain of dependencies the construct the ontology of images.
...
<Figure src={"/images/world-of-images/image3.png"}>
  ...
  *Figure 3* — A loose taxonomy of image types.
...
<Figure src={"/images/world-of-images/image4.png"}>
  ...
  *Figure 4* — Diagram representing the hypothesis of representational convergence.

...
social_image: /assets/images/world-of-images/seo-image.png
slug: "4"
tags: Images, Technics, Dialectics, Aesthetics
# image: /assets/images/world-of-images/image1.png
---
...
<blockquote class="blockquote-page">
  ...
  <p class="small small-caps attribution">Walter Benjamin, <em>The Arcades Project</em></p>
  ...
  <p class="small small-caps attribution">Friedrich Nietzsche, <em>The Will to Power</em></p>
</blockquote>
...
{/* <%= partial("partials/media", :locals => {
  :src => '/assets/images/world-of-images/image1.png',
  :title => 'Figure 1',
...
{/* <%= partial("partials/media", :locals => {
  :src => '/assets/images/world-of-images/image2.png',
  :title => 'Figure 2',
...
{/* 
<%= partial("partials/media", :locals => {
  :src => '/assets/images/world-of-images/image3.png',
  :title => 'Figure 3',
  :alt => 'Taxonomy of Images Diagram',
...
{/* <%= partial("partials/media", :locals => {
  :src => '/assets/images/world-of-images/image4.png',
  :title => 'Figure 4',

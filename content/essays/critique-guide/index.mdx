---
layout: post
title: "How to Exchange Critique"
...
Following up on my previous essay on design feedback, [Why Critique?](/essays/why-critique), I wanted to elaborate on what I've learned over the years about what makes critique "good." I'll break down many useful perspectives, examples, tips, and approaches for general-purpose design critique.
...
<Card centered={true} className="text-center">

<div className="flex flex-col gap-2 py-8 lowercase font-sans-sc">
  <span className="w-full">Observation</span>
  <span className="w-full text-gray-400">+</span>
  <span className="w-full">Impact</span>
  <span className="w-full text-gray-400">+</span>
  <span className="w-full">Question or Request</span>
  <span className="w-full text-gray-400">=</span>
  <span className="w-full font-sans-sc lowercase font-bold">Actionable Feedback</span>
</div>

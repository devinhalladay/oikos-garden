...
subtitle: "Facing a problem of having far too many alarms set on my phone every morning, I designed a solution that allows users to set a range of alarms in just one step."
tags: ['Product Design', 'iOS Apps']
cover_image: ../../static/images/2018/03/alarm-contexts/cover.png
filters: interaction
featured: true
categories: software
slug: '2018-03-24-alarm-contexts'
published: false
---

<div className="gc-spill">
  <Figure src={'/images/2018/03/alarm-contexts/1.jpg'} />
</div>

<div className="gc-main">
  <h2>A Better Way to Set Alarms</h2>
  <p>If you're anything like me you've experienced this annoying problem: you set about 10 alarms to wake up in the morning and have a list of over 100 alarms in Clock.app on your phone set at 5–25 minute intervals. You wake up and forget to turn off some of them and they go off in a meeting making you look stupid, or you set the wrong ones and wake up late.</p>
...
<div className="gc-spill dg dg-halves">
  <Figure src={'/images/2018/03/alarm-contexts/4.png'} />
  <Figure src={'/images/2018/03/alarm-contexts/3.png'} />
  <Figure src={'/images/2018/03/alarm-contexts/2.png'} />
</div>
...
cover_image: ../../src/images/2019/10/computational-covers/cover.png
...
<div className="gc-spill">
  {/*  partial("partials/figure", :locals => { :img => "../../src/images/2019/10/computational-covers/1.jpg" })  */}
  {/*  partial("partials/figure", :locals => { :img => "../../src/images/2019/10/computational-covers/2.png" })  */}
</div>
...
<div className="gc-spill">
{/*  partial("partials/figure", :locals => { :img => "../../src/images/2019/10/computational-covers/3.png" })  */}
</div>

...
tags: ['Product Design']
subtitle: "Designing an ethical, friendly, and personal inmate communications system."
cover_image: ../../static/images/2019/02/ncic/cover.png
tag: technology, politics
filters: interaction
categories: software
slug: '2019-02-20-ncic'
published: false
---


<div className="gc-breakout hero-image">
  <Figure src={'/images/2019/02/ncic/mockup.jpg'} />
</div>
...
<div className="gc-main">
  ...
  <Figure src={'/images/2019/02/ncic/visit-registration/1.png'} />

  <Figure src={'/images/2019/02/ncic/visit-registration/2.png'} />

  <Figure src={'/images/2019/02/ncic/visit-registration/3.png'} />

  <Figure src={'/images/2019/02/ncic/visit-registration/4.png'} />

  <Figure src={'/images/2019/02/ncic/visit-registration/5.png'} />
  ...
  <Figure src={'/images/2019/02/ncic/chat/1.png'} />

  <Figure src={'/images/2019/02/ncic/chat/2.png'} />

  <Figure src={'/images/2019/02/ncic/chat/3.png'} />

  <Figure src={'/images/2019/02/ncic/chat/4.png'} />
  ...
  <Figure src={'/images/2019/02/ncic/backend/1.png'} />

  <Figure src={'/images/2019/02/ncic/backend/2.png'} />

  <Figure src={'/images/2019/02/ncic/backend/3.png'} />

  <Figure src={'/images/2019/02/ncic/backend/4.png'} />
</div>
...
cover_image: ../../src/images/2017/08/quora-year-in-review/cover.png
filters: interaction
slug: '2017-08-01-quora-year-in-review'
---

<div className="gc-main">
  {/*  partial("partials/figure", :locals => { :img => "../../src/images/2017/08/quora-year-in-review/cover.png" })  */}
...
<div className="gc-spill">
  {/*  partial("partials/figure", :locals => { :img => "../../src/images/2017/08/quora-year-in-review/email.png" })  */}
</div>

...
const SectionHeading: FC<SectionHeading> = ({ title, subhead, link, icon }) => {
  return (
    <div className="mb-6 font-sans">
      <div className="border-b border-dashed border-gray-300 pb-1 mb-2 flex items-center gap-[8px]">
        {icon && <div className="grow-0">{icon}</div>}

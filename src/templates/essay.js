  ...
  return (
    <Layout
      ...
      >
        ...
        />
        <meta name="twitter:image" content={post.frontmatter.cover_image && `https://infinitecaesura.com/${post.frontmatter.cover_image.childImageSharp.fluid.src}` || "https://infinitecaesura.com/images/seo-image.png"} />
      </Helmet>
      <article
        className="blog-post"
        itemScope
